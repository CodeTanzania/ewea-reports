...
const eweaCase = require('@codetanzania/ewea-case');
...
const getEventCaseBaseAggregation = (criteria = {}) => {
  ...
  const base = eweaCase.Case.lookup(criteria, options);
...
const getEventCaseAnalysis = (criteria, done) => {
  ...
  const normalize = (result, next) => {
    ...
    const normalizedResultsAgeGroups = lodash.map(ageGroups, (group) => ({
      ...group,
      upperBoundary: group.lowerBoundary + 9,
    }));

    // merge all age groups
    const normalizedAgeGroups = lodash.sortBy(
      lodash.uniqBy(
...
exports.CASE_BASE_METRIC_FIELDS = CASE_BASE_METRIC_FIELDS;
exports.CASE_BASE_PROJECTION = CASE_BASE_PROJECTION;
exports.CASE_DEFAULT_PROJECTION = CASE_DEFAULT_PROJECTION;
exports.CASE_FACET_AGE_GROUPS = CASE_FACET_AGE_GROUPS;
exports.CASE_FACET_GENDER = CASE_FACET_GENDER;
exports.CASE_FACET_NATIONALITIES = CASE_FACET_NATIONALITIES;
exports.CASE_FACET_OCCUPATIONS = CASE_FACET_OCCUPATIONS;
exports.CASE_FACET_OVERVIEW = CASE_FACET_OVERVIEW;
exports.CASE_FACET_SEVERITIES = CASE_FACET_SEVERITIES;
exports.CASE_FACET_STAGES = CASE_FACET_STAGES;
...
exports.getEventCaseAnalysis = getEventCaseAnalysis;
exports.getEventCaseBaseAggregation = getEventCaseBaseAggregation;
